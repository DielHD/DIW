$(document).ready(function () {
  ...
  function populateBoxWithData(product, card) {
    ...
    card.find('p').wrap('<a href="details.html?id=' + productId + '"></a>');
  }
...
$(document).ready(function () {
  ...
  function populateBoxWithData(product, card) {
    ...
    card.find('.price').text('R$' + product.price.toFixed(2));
    var productId = product.id;
    card.find('h1').wrap('<a href="details.html?id=' + productId + '"></a>');
  }
...
$(document).ready(function () {
  ...
  $('form').submit(function (evento) {
    ...
    const url = `search.html?search=${termoBusca}&category=${categoriaSelecionada}`;
